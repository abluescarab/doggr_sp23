...
export class Migration20230430021352 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "message" ("message_id" serial primary key, "sender_id" int not null, "receiver_id" int not null, "message" varchar(255) not null, "created_at" timestamptz(0) not null);');
